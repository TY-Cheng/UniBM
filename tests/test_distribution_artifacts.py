...
class DistributionArtifactTests(unittest.TestCase):
    ...
    def test_wheel_metadata_and_typed_marker_are_present(self) -> None:
        with zipfile.ZipFile(self._wheel) as wheel:
            ...
            self.assertIn("unibm/_diagnostic_models.py", names)
    ...
    def test_sdist_contains_library_sources_but_not_repo_workflow_directories(self) -> None:
        ...
        self.assertIn(f"{prefix}src/unibm/_diagnostic_models.py", names)
        ...
        self.assertIn(f"{prefix}src/unibm/evi/_summaries.py", names)
        self.assertIn(f"{prefix}src/unibm/evi/bootstrap.py", names)
        self.assertIn(f"{prefix}src/unibm/evi/core.py", names)
        ...
        self.assertIn(f"{prefix}src/unibm/ei/native.py", names)
        self.assertIn(f"{prefix}src/unibm/ei/paths.py", names)
        self.assertIn(f"{prefix}src/unibm/ei/threshold.py", names)
        self.assertIn(f"{prefix}src/unibm/ei/_internal.py", names)
        self.assertIn(f"{prefix}src/unibm/diagnostics.py", names)
        self.assertIn(f"{prefix}src/unibm/plotting.py", names)
