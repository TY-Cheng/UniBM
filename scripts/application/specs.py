...
APPLICATIONS = (
    ApplicationSpec(
        ...
        provider="ghcn",
        label="Houston precipitation · EWMA normalized",
        figure_stem="houston_precipitation",
        raw_key="USW00012918.csv.gz",
        ylabel="precipitation / past EWMA level",
        time_series_title="Houston normalized full-calendar daily precipitation",
    ...
    ApplicationSpec(
        ...
        provider="ghcn",
        label="Phoenix hot-dry severity · EWMA normalized",
        figure_stem="phoenix_hotdry",
        raw_key="USW00023183.csv.gz",
        ylabel="severity / past EWMA level",
        time_series_title="Phoenix normalized full-calendar daily severity",
    ...
    ApplicationSpec(
        ...
        raw_key="TX",
        ylabel="daily building-claim total (2025 USD)",
        time_series_title="Texas NFIP daily building-claim totals and annual maxima",
        scaling_title="Texas NFIP active-day sliding block-maxima quantile scaling",
        scaling_ylabel="log block-maximum quantile (active days)",
        time_series_annual_max_yscale="log",
        design_life_level_basis="claim_active_day",
        design_life_level_label="Design life (years)",
        design_life_level_yscale="log",
    ...
    ApplicationSpec(
        ...
        raw_key="FL",
        ylabel="daily building-claim total (2025 USD)",
        time_series_title="Florida NFIP daily building-claim totals and annual maxima",
